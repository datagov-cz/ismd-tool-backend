...
/**
 * Tests for {@link CorsConfigUtil} simulating localhost environment
 *
 * @see CorsConfig
 */
@SpringBootTest
...
@TestPropertySource(properties = {
        ...
        "spring.datasource.url=jdbc:h2:mem:testdb-local-cors;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE;INIT=CREATE SCHEMA IF NOT EXISTS ismd_schema",
