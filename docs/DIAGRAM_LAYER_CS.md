...
3. Ověří, že pojem nebyl pod overlayem od jeho nasazení editován (otisk „stale-base" na `updatedAt` pojmu). Pokud se posunul, změna je hlášena jako konflikt, místo aby tiše přepsala mezitimní úpravu.
